# This Makefile is for the Db::Mediasurface extension to perl.
#
...
#	ABSTRACT_FROM => q[Mediasurface.pm]
#	AUTHOR => q[Nigel Wetters <nwetters@cpan.org>]
#	NAME => q[Db::Mediasurface]
#	PREREQ_PM => { Db::Mediasurface::ReadConfig=>q[0], Db::Mediasurface::Cache=>q[0], DBI=>q[0] }
#	VERSION_FROM => q[Mediasurface.pm]
...
DISTNAME = Db-Mediasurface
NAME_SYM = Db_Mediasurface
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
FULLEXT = Db/Mediasurface
BASEEXT = Mediasurface
PARENT_NAME = Db
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Db
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Db
...
TO_INST_PM = Mediasurface.pm

PM_TO_BLIB = Mediasurface.pm \
	$(INST_LIBDIR)/Mediasurface.pm
...
manifypods : pure_all Mediasurface.pm
	@$(POD2MAN) \
	Mediasurface.pm \
	$(INST_MAN3DIR)/Db::Mediasurface.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIBDIR)/Mediasurface.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Db-Mediasurface\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Db-Mediasurface</TITLE>\n}. qq{\t<ABSTRACT>manipulates a Mediasurface database.</ABSTRACT>\n}. qq{\t<AUTHOR>Nigel Wetters &lt;nwetters\@cpan.org&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"DBI\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Db-Mediasurface-Cache\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Db-Mediasurface-ReadConfig\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"sun4-solaris\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Db-Mediasurface.ppd
